...
{
    public class OrSplitWidget : PetriNetElementWidget
    {
        public OrSplitWidget()
        {
        }

        public OrSplitWidget(PetriNetElement element) : base(element)
        {
        }

        public override Type ElementType
        {
            get { return typeof(OrSplit); }
        }
        ...
        public override void Render(WidgetRenderingContext context)
        {
            ...
            g.FillRectangle(!context.IsSelected ? Brushes.Gainsboro : Brushes.DarkGray, Location.X + Size / 10, Location.Y - Size / 2, Size / 10 * 4, Size);
